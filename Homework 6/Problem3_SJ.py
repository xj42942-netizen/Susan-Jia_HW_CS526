...
def gale_shapley(men_prefs, women_prefs, n):
    ...
    next_prop = {m: 0 for m in men_prefs}
    engagements = {}
...
def process_one_file(input_file, output_file):
    ...
    men_prefs, women_prefs, n, man_names, woman_names = load_preferences(input_file)
...
def main():
    ...
    tasks = [
        ("marriage_ten.txt", "ten_output.txt"),
        ("marriage_hundred.txt", "hundred_output.txt"),
        ("marriage_thousand.txt", "thousand_output.txt")
    ]
